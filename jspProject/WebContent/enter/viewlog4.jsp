...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../enter/images/미운우리새끼.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">11.1</span> 
<input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>  
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>예능소개</h2>
      <h5><span class="glyphicon glyphicon-time"></span>방영일자 2016-08-26 ~ 방영중</h5>
      <p>
       <미운 우리 새끼>는 엄마가 화자가 되어 아들의 일상을 관찰하고, 
          육아일기라는 장치를 통해 순간을 기록하는 프로그램
      </p>
</form>
