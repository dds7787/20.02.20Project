...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../enter/images/신비한TV서프라이즈.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">4.9</span>
<input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>   
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>예능소개</h2>
      <h5><span class="glyphicon glyphicon-time"></span>방영일자 2002-04-07 ~ 방영중</h5>
      <p>
          우리 주변의 작고 사소한 사건으로부터 세계적인 사건들을
          재연 형식으로 재구성하여 누구나 한 번쯤 생각해봤을 것 같은 
      '과연 그 사건이 사실일까' 그리고 '과연 그 사건의 진실은 무엇일까'라는 의문을
          시청자와 함께하여 새로운 정보와 재미를 주고자 하는 프로그램
      </p>
</form>
