  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#" id="log_view"><span class="glyphicon glyphicon-user"></span>${sessionScope.userid}님</a></li>
...
<div class="container text-center">    
  <div class="well">
      <h3>공지사항</h3>
       <ul id="a1">
        <li><a href="../notiec_servlet/viewlog.do?num=1">미디어vod공지</a></li>
        <li><a href="#">커뮤니티공지</a></li>
        <li><a href="../notiec_servlet/viewlog.do?num=3">공지1</a></li>
       </ul>
      </div>
  <div class="row">
    <div class="col-sm-4">
