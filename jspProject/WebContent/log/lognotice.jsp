...
<div class="container">
  <h2>로그인</h2>
  <form action="${path}/log_servlet/log_bcrypt2.do"> <!-- action="${path}/log_servlet/log_bcrypt2.do"-->
  ...
  <!--   <div class="checkbox">
    ...
    <button class="btn btn-primary btn-lg btn-block">로그인</button><br>
