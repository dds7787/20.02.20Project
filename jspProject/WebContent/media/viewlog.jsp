...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../media/images/천문.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">8.82</span>
<input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>   
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>영화줄거리</h2>
      <h5><span class="glyphicon glyphicon-time"></span>개봉일자 2019-12-26</h5>
      <p>
         역사상 가장 위대한 왕 세종
         관노로 태어나 종3품 대호군이 된 천재 과학자 장영실
      20년간 꿈을 함께하며 위대한 업적을 이뤄낸 두 사람이었지만 
         임금이 타는 가마 안여(安與)가 부서지는 사건으로 세종은 장영실을 문책하며
         하루아침에 궁 밖으로 내치고 그 이후 장영실은 자취를 감추는데… 
