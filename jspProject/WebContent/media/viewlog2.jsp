...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../media/images/시동.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">8.7</span> 
<input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>  
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>영화줄거리</h2>
      <h5><span class="glyphicon glyphicon-time"></span>개봉일자 2019-12-18</h5>
      <p>
           학교도 싫고 집도 싫고 공부는 더더욱 싫다며
         '엄마'(염정아)에게 1일 1강스파이크를 버는 반항아
        '택일'(박정민). 절친 '상필'(정해인)이
           빨리 돈을 벌고 싶다며사회로 뛰어들 때, 무작정 집을 뛰쳐나간 
       '택일'은 우연히 찾은 장품반점에서 남다른 포스의 주방장
       '거석이형'(마동석)을 만나게 된다. 
         강렬한 첫 인사를 나누자마자 인생 최대 적수가 된 
      '거석이형'과 '택일'. 세상 무서울 것 없던 
      '택일'은 장품반점에서 상상도 못한 이들을 만나 진짜 세상을 맛보게 되는데...
      </p>
</form>
<!--댓글 쓰기 폼 -->
 <h2>리뷰</h2>
