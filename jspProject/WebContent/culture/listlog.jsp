...
$(function(){
	$("#btnWrite").click(function(){
		location.href="${path}/culture/write.jsp";
	});
});
//클릭한 페이지 이동
function list(page){
	location.href="${path}/culture_servlet/listlog.do?curPage="+page;
}
//로그아웃
$(function(){
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">시사</div>
        <div class="panel-body"><a href="viewlog1.do?num=1">
        <img src="../culture/images/아침이좋다.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">아침이좋다</div> 
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        ...
        <img src="../culture/images/생생정보통.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">생생정보통</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        ...
        <img src="../culture/images/모닝와이드.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">모닝와이드</div>
      </div>
    </div>
  </div>
</div><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <img src="../culture/images/그것이알고싶다.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">그것이알고싶다</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <img src="../culture/images/맨인블랙박스.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">맨인블랙박스</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <img src="../culture/images/실제상황.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">실제상황</div>
      </div>
    </div>
  </div>
</div><br><br>
...
<form name="form1" method="post" action="${path}/culture_servlet/searchlog.do">
...
<table class="table table-condensed">
 ...
 <c:forEach var="dto" items="${list}">
  ...
  <tr>
    ...
    <a href="${path}/culture_servlet/viewlog${dto.num}.do?num=${dto.num}">
    ${dto.subject}</a>
    <!--댓글갯수 표시  -->
