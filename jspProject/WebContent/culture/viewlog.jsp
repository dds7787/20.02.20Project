...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../culture/images/아침이좋다.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">1.6</span>
  ...
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>
   ...
   <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-sm">
      ...
      <h2>시사교육소개</h2>
      <h5><span class="glyphicon glyphicon-time"></span>방영일자 2016-04-25 ~ 방영중</h5>
      <p>
          대한민국의 아침을 열어줄 신개념 아침방송이 온다! 
          밤사이 따끈따끈한 소식은 물론 활기차고 힘 나는 아침 풍경과 
          그 속에 살아가는 사람들 이야기까지 생생하게 전달하는 프로그램
      </p>
</form>
