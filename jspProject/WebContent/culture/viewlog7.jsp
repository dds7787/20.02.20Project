...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../culture/images/도전골든벨.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">5.6</span>
 <input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>시사교육소개</h2>
      <h5><span class="glyphicon glyphicon-time"></span>방영일자 2000-03-31 ~ 방영중</h5>
      <p>
       100명의 패기 넘치는 청소년들이 50문제에 도전하는 
          퀴즈 프로그램으로 단순히 퀴즈 대결에서 일등을 뽑는데 
          중점을 두는 것보다 문제를 푸는 과정에서 나타나는 
          청소년들의 재치와 생각을 알아보는 청소년 프로그램
      </p>
</form>
