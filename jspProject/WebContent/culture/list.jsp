  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="../drama_servlet/list.do">드라마</a></li>
...
<form name="form1" method="post" action="${path}/culture_servlet/search.do">
...
<table class="table table-condensed">
 ...
 <c:forEach var="dto" items="${list}">
  ...
  <tr>
    ...
    <a href="${path}/culture_servlet/view${dto.num}.do?num=${dto.num}">
    ${dto.subject}</a>
    <!--댓글갯수 표시  -->
