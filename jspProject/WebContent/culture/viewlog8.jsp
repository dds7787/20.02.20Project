...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../culture/images/인간극장.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">9.2</span>
 <input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>시사교육소개</h2>
      <h5><span class="glyphicon glyphicon-time"></span>방영일자 2000-05-01 ~ 방영중</h5>
      <p>
         드라마 같은 삶의 무대에 당신을 초대합니다. 
         보통 사람들의 특별한 이야기, 특별한 사람들의 평범한 이야기를 
         비롯한 치열한 삶의 바다에서 건져 올린 우리 이웃들의 이야기를 전달하는 프로그램
      </p>
</form>
