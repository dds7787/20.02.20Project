...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../culture/images/모닝와이드.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">3.7</span>
 <input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>시사교육소개</h2>
      <h5><span class="glyphicon glyphicon-time"></span>방영일자 1991-12-10 ~ 방영중</h5>
      <p>
         당신의 아침이 바뀝니다. 이제껏 볼 수 없었던 차별화된, 생동감 넘치는, 스타일리시한 신개념 시사 정보 프로그램
      </p>
</form>
