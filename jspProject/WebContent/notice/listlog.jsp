...
$(function(){
	$("#btnguest").click(function(){
		location.href="${path}/guest_servlet/list.do";
	});
});
function list(page){
	location.href="${path}/notiec_servlet/listlog.do?curPage="+page;
}
...
<div class="container">
  ...
  <div class="btn-group btn-group-justified">
    <a href="#" class="btn btn-primary">서비스공지</a>
    <a href="#" id="btnWrite" class="btn btn-primary">글쓰기</a>
    <a href="#" id="btnguest" class="btn btn-primary">1:1상담</a>
  </div>
</div>
<br>
...
<div class="container">
  ...
  <ul class="list-group" id="myList">
    ...
    <li class="list-group-item"><a href="${path}/notiec_servlet/viewlog.do?num=1">미디어vod공지사항</a></li>
    <li class="list-group-item"><a href="${path}/notiec_servlet/viewlog.do?num=2">공지사항1</a></li>
    <li class="list-group-item"><a href="${path}/notiec_servlet/viewlog.do?num=3">공지사항2</a></li>
    <li class="list-group-item"><a href="${path}/notiec_servlet/viewlog.do?num=4">공지1</a></li>
  </ul>  
</div> 
...
<table class="table table-bordered table-striped">
 ...
 <c:forEach var="dto" items="${list}">
  ...
  <tr>
    ...
    <a href="${path}/notiec_servlet/viewlog.do?num=${dto.num}">
    ${dto.subject}</a>
    <!--댓글갯수 표시  -->
