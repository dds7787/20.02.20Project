...
$(function(){
	$("#btnWrite").click(function(){
		location.href="${path}/drama/write.jsp";
	});
});
//클릭한 페이지 이동
function list(page){
	location.href="${path}/drama_servlet/listlog.do?curPage="+page;
}
//로그아웃
$(function(){
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">드라마</div>
        <div class="panel-body"><a href="viewlog1.do?num=1">
        <img src="../drama/images/사랑의불시착.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">사랑의불시착</div> 
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        ...
        <img src="../drama/images/낭만닥터김사부2.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">시즌2낭만닥터김사부</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        ...
        <img src="../drama/images/더게임.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">더게임:0시를향하여</div>
      </div>
    </div>
  </div>
</div><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <img src="../drama/images/포레스트.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">포레스트</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <img src="../drama/images/스토브리그.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">스토브리그</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <img src="../drama/images/99억의여자.jpg" class="img-responsive" style="width:100%" alt="Image"></a></div>
        <div class="panel-footer">99억의여자</div>
      </div>
    </div>
  </div>
</div><br><br>
...
<form name="form1" method="post" action="${path}/drama_servlet/searchlog.do">
...
<table class="table table-condensed">
 ...
 <c:forEach var="dto" items="${list}">
  ...
  <tr>
    ...
    <a href="${path}/drama_servlet/viewlog${dto.num}.do?num=${dto.num}">
    ${dto.subject}</a>
    <!--댓글갯수 표시  -->
    ...
    <td align="center">
      <c:if test="${dto.filesize > 0}">
       <a href="${path}/drama_servlet/download.do?num=${dto.num}">
