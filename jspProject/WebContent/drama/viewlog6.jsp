...
<%--   <tr>   
  ...
  <tr>
   <td>
     ...
     <source src="../drama/images/99억의여자.mp4">
...
<%--   <tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div class="container">
      <b>시청률:</b><span class="badge">7.0</span>
 <input type="button" class="btn btn-primary" value="목록" id="btnList">
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">스트리밍이용권</button>  
    ...
    <div class="modal-dialog modal-sm">
      ...
      <h2>드라마소개</h2>
      <h5><span class="glyphicon glyphicon-time"></span>2019.12.04~2020.01.23 방영종료 32부작</h5>
      <p>
         우연히 현찰 99억을 움켜쥔 여자가 세상과 맞서 싸우는 이야기
      </p>
</form>
 <h2>댓글</h2>
  <form role="form">
